...
| **Permissions** | Coralogix Permissions provide granular role-based access control to secure your observability data. | • [Team Permissions Management service](https://docs.coralogix.com/api-reference/team-permissions-management-service/overview) |
