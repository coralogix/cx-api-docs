...
| Method                        |
|-------------------------------|
| [Get alert definition by ID](https://docs.coralogix.com/api-reference/alert-definitions-service/get-alert-definition-by-id) |
| [Get alert definition by alert version ID](https://docs.coralogix.com/api-reference/alert-definitions-service/get-alert-definition-by-alert-version-id) |
| [Create an alert](https://docs.coralogix.com/api-reference/alert-definitions-service/create-an-alert) |
| [Replace an alert definition](https://docs.coralogix.com/api-reference/alert-definitions-service/replace-an-alert-definition) |
| [Get a list of all accessible alert definitions](https://docs.coralogix.com/api-reference/alert-definitions-service/get-a-list-of-all-accessible-alert-definitions) |
| [Download alerts](https://docs.coralogix.com/api-reference/alert-definitions-service/download-alerts) |
| [Delete alert definition](https://docs.coralogix.com/api-reference/alert-definitions-service/delete-v3alert-defs) |
| [Disable or enable an alert](https://docs.coralogix.com/api-reference/alert-definitions-service/disable-or-enable-an-alert) |
