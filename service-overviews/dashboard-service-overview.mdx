...
For broader product context, see [Manage dashboard settings](https://coralogix.com/docs/user-guides/custom-dashboards/tutorials/manage-dashboard-settings/) and [Dashboard metadata](https://coralogix.com/docs/user-guides/custom-dashboards/tutorials/dashboard-metadata/).
