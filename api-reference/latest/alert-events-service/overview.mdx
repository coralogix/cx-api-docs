...
| Method                        |
|-------------------------------|
| [Get alert event by ID](https://docs.coralogix.com/api-reference/alert-events-service/get-alert-event-by-id) |
| [Get alert events statistics](https://docs.coralogix.com/api-reference/alert-events-service/get-alert-events-statistics) |
