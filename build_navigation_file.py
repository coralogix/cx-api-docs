...
def build_version_groups(api_ref_path: Path, version: str, config: dict) -> List[dict]:
    ...
    # Introduction holds the version landing page, plus the v5-only changelog
    # (CI-generated by build_changelog.py; kept here to avoid a redundant
    # "Changelog > Changelog" group). See CLAUDE.md.
    intro_pages = [config['intro_page']]
    if version == 'v5':
        intro_pages.append("changelog")
